...
function menuClick(menuSq, menuName) {
    ...
    if ($('#menu' + menuSq).hasClass("click_white") === true) {
        ...
        $('#menuForm').append("<div class='menuColDiv" + menuSq + " row' style='text-align: left'>" + "<input type='hidden' id='menuInput" + menuSq + "' name='menuSq' value=" + menuSq + ">" +
            "<p name='menuName'id='menuName" + menuSq + "' style='font-size: 14px;padding-top: 10px;max-width: 40%;' class='col' data-value=" + menuName + ">" + menuName + "</p>" +
            "<input type='number'id='menuNumber" + menuSq + "' min='0' class='form-control col' style='max-width: 40%;' name='menuSize' value='1'>"
            + "</div>");
